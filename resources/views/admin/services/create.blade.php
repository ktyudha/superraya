...
@section('content')
    ...
    <div class="flex flex-col gap-9">
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <form class="form-horizontal" id="form-posts" action="{{ route('admin.services.store') }}" method="post"
                ...
                <div class="p-6.5">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea rows="2" placeholder="Short Description of the service" name="description_short"
                            class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">{{ old('description_short') }}</textarea>
                    </div>
                    ...
                    <div id="added-product">
                        {{--  <div id="layout-product-0">
                            <button type="button" onclick="imageRemove(this,0)"
                            ...
                            <div class="my-6 grid lg:grid-cols3 md:grid-cols-3 grid-cols-1 gap-3">
