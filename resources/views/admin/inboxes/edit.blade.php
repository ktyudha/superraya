...
@section('content')
    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="hover:text-primary">
                    <a class="font-medium" href="{{ route('admin.inboxes.index') }}">Inboxes /</a>
                </li>
                <li class="font-medium">Edit /</li>
                <li>
                    <a class="font-medium text-primary"
                        href="{{ route('admin.inboxes.edit', $model->id) }}">{{ $model->name }}</a>
                </li>
            </ol>
        </nav>
    </div>
    ...
    <div class="flex flex-col gap-9">
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <form class="form-horizontal" id="form-posts" action="{{ route('admin.inboxes.update', $model->id) }}"
                method="post">
                {{ method_field('put') }}
                {{ csrf_field() }}
                <div class="p-6.5">
                    <div class="mb-4.5">
                        ...
                        <input type="text" placeholder="Name of the inboxes" name="name"
                            value="{{ old('name') ?? $model['name'] }}" readonly
                    ...
                    <div class="mb-4.5">
                        ...
                        <input type="text" placeholder="Email of the inboxes" name="email"
                    ...
                    <div class="form-control mb-3">
                        ...
                        <textarea rows="3" placeholder="Message of the inboxes" name="description" id="description" readonly
