...
@section('content')
            ...
            <ol class="flex items-center gap-2">
                ...
                <li>
                    <a class="font-medium text-primary"
                        href="{{ route('admin.product.categories.edit', $model->id) }}">{{ $model->name }}</a>
                </li>
            </ol>
        </nav>
    </div>
    ...
    <div class="flex flex-col gap-9">
        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <form class="form-horizontal" action="{{ route('admin.product.categories.update', $model->id) }}" method="post"
                enctype="multipart/form-data" id="form-categories">
                {{ method_field('put') }}
                {{ csrf_field() }}
                <div class="p-6.5">
                    <div class="mb-4.5">
                        ...
                        <input type="text" placeholder="Name of the service" name="name"
