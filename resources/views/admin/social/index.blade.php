...
@section('content')
    ...
    <div class="flex">
        <a href="{{ route('admin.social.create') }}"
            ...
            <i class="fa-solid fa-plus"></i> Add Social
        </a>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                                ...
                                <a href="{{ $model['url'] }}" target="_blank"
                                    class="inline-flex rounded-full uppercase bg-{{ $classes[@$key % 4] }} bg-opacity-10 px-3 py-1 text-sm font-medium text-{{ $classes[@$key % 4] }} ">
                                    {{ @$model['type'] }}
                                </a>
                            </td>
